...
| Member (signature) | Kind | Decomp path | Used by | Mod code ref(s) | 4750 | Notes |
|---|---|---|---|---|---|---|
| `KittenEva` (type; `is KittenEva`) | direct typed API | `KSA/KittenEva.cs:13` | garrys-torch, doh, kitten-animations, thug-life, graffiti | `WeldEngine.cs`; `KittenSpawner.cs`; `KittenAvatarAccessor.cs`; `KittenGlassesPreset.cs:38`; `graffiti.lib/DecalPicker.cs` | OK | garrys now uses the compile-checked type; the former type-name string comparison is retired |
