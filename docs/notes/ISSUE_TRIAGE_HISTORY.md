# Historical issue triage

These are dated reports from before the workspace redesign. Removed features are not active work items. Current issues and validation status are in [ISSUES.md](../../ISSUES.md) and [scope/FULL_SCOPE.md](../../scope/FULL_SCOPE.md).
