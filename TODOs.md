...
- [ ] garrys-torch: when a weldee (source) is welded, animations on that thing (like light part actuation) and kitten animations dont work.  research if you can figure out what it is we are doing that breaks that aspect
...
- [ ] its-so-shiny: completely broken
- [ ] blinky: completely broken
- [ ]
