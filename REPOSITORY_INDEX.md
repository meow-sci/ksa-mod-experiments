...
| [pebbles.lib](pebbles.lib/README.md) | Pick/import a mesh, set linked mesh/collider scale, and replace selected or all planet clutter types; automatic GLB textures, transformed/secondary UVs and warned material/detail-map fallbacks. | Per-body applied override, original-state restoration and retained GLB assets. |
