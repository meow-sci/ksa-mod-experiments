...
- Placement settings: width/height, depth (0 = auto: half the larger side, floored at 0.3 m hull / 1 m terrain — a too-shallow box crops wide decals on curved hulls), roll, range, alpha, brightness, debug-checker toggle
