...
| [pebbles.lib](pebbles.lib/README.md) | Pick/import a mesh, set linked mesh/collider scale, and replace selected or all planet clutter types; automatic GLB textures and common Blender material fallbacks. | Per-body applied override, original-state restoration and retained GLB assets. |
