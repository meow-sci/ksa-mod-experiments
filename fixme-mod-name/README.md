...
| `fixme-mod-name.csproj` | Main mod project |
| `fixme-mod-name.lib/FixmeModNameLib.cs` | Library class (headless logic) |
...
public static class Patcher
{
    ...
    {
        harmony = new Harmony("MeowSci.FixmeModName");
...
```csharp
public static class FixmeModNameLib
{
...
### Step 1: Rename
```
fixme-mod-name → your-cool-mod
FixmeModName → YourCoolMod
MeowSci.FixmeModName → MeowSci.YourCoolMod
```
...
- [Fixme library](../fixme-mod-name.lib/README.md) - The library paired with this nonshipping standalone template.
