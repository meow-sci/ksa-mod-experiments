...
public sealed partial class ItsSoShinySubmod
{
    ...
    private DraftBindings CreateDraftBindings()
    {
        ...
        state.Value("configCols", () => _configCols, value => _configCols = value);
        state.Value("configRows", () => _configRows, value => _configRows = value);
        state.Value("configSpacing", () => _configSpacing, value => _configSpacing = value);
        ...
        state.Value("configLightScale", () => _configLightScale, value => _configLightScale = value);
        state.Value("configLayoutIndex", () => _configLayoutIndex, value => _configLayoutIndex = value);
        state.Value("configIntensity", () => _configIntensity, value => _configIntensity = value);
