...
| `humble-arteest.csproj` | Main mod project |
| `humble-arteest.lib/HumbleArteestLib.cs` | Library class (headless logic) |
...
public static class Patcher
{
    ...
    {
        harmony = new Harmony("MeowSci.HumbleArteest");
...
```csharp
public static class HumbleArteestLib
{
...
### Step 1: Rename
```
humble-arteest → your-cool-mod
HumbleArteest → YourCoolMod
MeowSci.HumbleArteest → MeowSci.YourCoolMod
```
