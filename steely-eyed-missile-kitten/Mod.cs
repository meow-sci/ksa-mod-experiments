...
public class Mod
{
  ...
  public void OnAfterUi(double dt)
  {
    ...
    {
      Console.WriteLine($"steely-eyed-missile-kitten: Error in OnAfterUi: {ex.Message}");
    }
  }
  ...
  private void RenderWindow()
  {
    ...
    // Begin window
    if (ImGui.Begin("steely-eyed-missile-kitten Mod", ref _windowVisible))
    {
      // Header
      ImGui.TextColored(new float4(0.0f, 1.0f, 0.0f, 1.0f), "steely-eyed-missile-kitten");
      ImGui.Separator();
