...
- update "unscience" top-level mod csproj with references all the new mod.lib projects to be an all-in-one supermod with access to all the mod features.  just update the csproj for compile time linkage, dont implement any mod code.