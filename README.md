...
[Pebbles](pebbles.lib/README.md) adds per-celestial ground clutter mesh/material replacement, placement controls, a detached mesh/collider Workshop and runtime `.glb` file browsing/import with embedded PNG/JPEG materials. Apply and original-state restoration use per-body live ownership; saving and loading only affect authoring recipes.
