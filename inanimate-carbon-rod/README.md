...
| `inanimate-carbon-rod.csproj` | Main mod project |
| `inanimate-carbon-rod.lib/InanimateCarbonRodLib.cs` | Library class (headless logic) |
...
public static class Patcher
{
    ...
    {
        harmony = new Harmony("MeowSci.InanimateCarbonRod");
...
```csharp
public static class InanimateCarbonRodLib
{
...
### Step 1: Rename
```
inanimate-carbon-rod → your-cool-mod
InanimateCarbonRod → YourCoolMod
MeowSci.InanimateCarbonRod → MeowSci.YourCoolMod
```
