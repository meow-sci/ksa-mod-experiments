...
/// <summary>
/// Per-vehicle UI state. Grid/animation state lives in BlinkyGridManager.
/// </summary>
internal class VehicleUiState
{
...
public class Mod
{
    ...
    public void OnAfterUi(double dt)
    {
        try
        {
            ...
            // Tick scroll animations on ALL vehicles via the shared manager
